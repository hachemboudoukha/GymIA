"""
Module de détection et comptage des pull-ups.

Ce module utilise MediaPipe Pose pour détecter les pull-ups en temps réel
...
class PullUpDetector:
    """
    Détecteur de pull-ups utilisant MediaPipe Pose.
    
    Analyse l'angle du coude pour détecter les répétitions de pull-ups.
    """
    
    def __init__(self, config_path: Optional[str] = None):
        """
        Initialise le détecteur de pull-ups.
        ...
        if config_path is None:
            config_path = Path(__file__).parent / "pull_up_config.json"
    ...
    def detect(self, frame: np.ndarray) -> Tuple[np.ndarray, Dict]:
        """
        Détecte les pull-ups dans une frame vidéo.
