"""
Module de détection et comptage des push-ups.

Ce module utilise MediaPipe Pose pour détecter les push-ups en temps réel
...
class PushUpDetector:
    """
    Détecteur de push-ups utilisant MediaPipe Pose.
    
    Analyse l'angle du coude pour détecter les répétitions de push-ups.
    """
    
    def __init__(self, config_path: Optional[str] = None):
        """
        Initialise le détecteur de push-ups.
        ...
        if config_path is None:
            config_path = Path(__file__).parent / "push_up_config.json"
    ...
    def detect(self, frame: np.ndarray) -> Tuple[np.ndarray, Dict]:
        """
        Détecte les push-ups dans une frame vidéo.
